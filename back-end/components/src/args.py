...
product_put_args.add_argument('nom', type=str, required=True, help='Nom manquant')
product_put_args.add_argument('buy_prix', type=float, required=True, help='Prix manquant')
